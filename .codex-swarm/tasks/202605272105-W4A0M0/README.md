...
doc_version: 2
doc_updated_at: "2026-05-27T21:12:10+00:00"
...
---
## Summary
Added a password visibility toggle to the shared login form and added a static favicon asset so browser requests to /favicon.ico no longer hit a failing dynamic path.
...
- Added apps/web/public/favicon.ico as a static icon asset.

## Risks
Low. The form change is UI-only and keeps the existing submit flow. The fetch option only prevents cached auth/profile responses. The favicon is a static public asset.
...
## Rollback Plan
Revert commit 6d634be1bdf8 to remove the login form toggle, no-store fetch options, and static favicon asset.
