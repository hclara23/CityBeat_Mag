      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600">
            Place ads throughout our website to reach engaged readers
          </p>
        </div>
              ...
              <form onSubmit={handleCreateCampaign} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Summer Product Banner"
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    This is the internal name for your banner campaign
                  </p>
                </div>

                <div>
                  <label htmlFor="bannerUrl" className="block text-sm font-semibold text-gray-900 mb-2">
                    Banner Image URL
                  </label>
                  <input
                    type="url"
                  ...
                  />
                  <p className="text-xs text-gray-600 mt-1">
                    Recommended size: 728x90 (leaderboard), 300x250 (medium rectangle), or 160x600 (wide skyscraper)
                  </p>
                </div>
            ...
            <Card className="sticky top-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-xs text-gray-600 mb-3">
                  Your banner will be placed in premium positions throughout our website,
                  reaching thousands of daily readers.
                </p>
