...
const translations = {
  en: {
    ...
    claimSub: 'Verify ownership for free to manage this listing. Premium upgrades are optional.',
    ...
    claimBtn: 'Claim This Business',
    pendingClaim: 'This listing is claimed and pending editor approval.',
    pendingClaimSub: 'Our editors will verify ownership and activate access shortly.',
    ...
    claimSuccessSub: 'Your request has been submitted for review. An editor will approve it shortly.',
    claimCancelled: 'Checkout was cancelled. You can continue managing the claim anytime.',
  ...
  es: {
    ...
    claimSub: 'Verifique la propiedad gratis para administrar este perfil. Las mejoras Premium son opcionales.',
    ...
    claimBtn: 'Reclamar Este Negocio',
    pendingClaim: 'Este perfil está reclamado y pendiente de aprobación del editor.',
    pendingClaimSub: 'Nuestros editores verificarán la propiedad y activarán el acceso en breve.',
    ...
    claimSuccess: '¡Solicitud de reclamación enviada!',
    claimSuccessSub: 'Su solicitud ha sido enviada para revisión. Un editor la aprobará en breve.',
    claimCancelled: 'El pago fue cancelado. Puede continuar con la reclamación en cualquier momento.',
...
export default function ListingDetailPage({ initialListing = null }: { initialListing?: Listing | null }) {
  ...
  return (
    <CityBeatShell locale={locale}>
      {/* LocalBusiness JSON-LD is rendered server-side in page.tsx (in the
          initial HTML) so Google reliably indexes it. */}
